...
rholist=seq(0.1,1,length.out = 10)
model3S0=c()
model3S1=c()
model3elnet=c()
model3gscca=c()
for(rho in 1:length(rholist)){
  ...
  model3gscca=rbind(model3gscca,finals(gscca.simu.normal(10,edges,u,v,50,'normal',1,sigma_x,sigma_y,plain=F,gamma.u = 2.12,gamma.v = 2.12)))
}
