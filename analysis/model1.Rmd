...
model1S0=s0cca_simu(12,u,v,50,'normal',1,sigma_x,sigma_y)
model1S1=s1cca_simu(12,u,v,50,'normal',1,sigma_x,sigma_y)
model1elnet=elnet.cca.simu(12,u,v,50,'normal',1,sigma_x,sigma_y)
model1gscca=gscca.simu.normal(12,edges,u,v,50,'normal',1,sigma_x,sigma_y)
```
