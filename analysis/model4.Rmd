...
model4gsccas1=finals(gscca.simu.normal(100,edges,u,v,50,'normal_oth',1,sigma_x,sigma_y,gamma.u = 2.12,gamma.v = 2.12))
```
...
model4gsccas2=finals(gscca.simu.normal(100,edges,u,v,50,'normal_mis',1,sigma_x,sigma_y,plain = F))
```
